...
export const PRODUCT_KNOWLEDGE: {
  ...
  product: {
    name: "PostLab AI",
    mission:
      "مساعدة الأنشطة التجارية العربية والليبية على إنشاء إعلانات متوافقة وفعّالة عبر ذكاء اصطناعي يفهم النصوص والصور وهوية النشاط التجاري.",
  },
  capabilities: [
    {
    ...
    },
    {
      ...
      description:
        "توليد نصوص إعلانية باللهجة الليبية (غربية/شرقية/جنوبية)، مع وضع وصف+صورة للمستويات الأعلى.",
    ...
    },
    {
      ...
      description:
        "توليد تصاميم/منشورات بهوية النشاط عبر مسار توليد الصور من داخل محادثة حمزاوي (مستوى 4+).",
      runtimeNotes:
        "خط أنابيب التوليد موجود في الكود، لكن توفر المزوّد وقت التشغيل غير مؤكد (يُعالج في Task #43). لا تَعِد بتوليد الصور إذا كان غير متاح فعلياً.",
    },
    {
