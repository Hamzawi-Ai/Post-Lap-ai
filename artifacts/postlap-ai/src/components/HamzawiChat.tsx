...
const i18n = {
  ar: {
    ...
    welcome: "أهلاً! 👋 أنا نادر، مساعدك في PostLab للخدمات التسويقية. قلّي على نشاطك وأولّد لك منشوراتك ونصوصك الإعلانية بالليبي الأصيل، وأصمّم صورها بهوية نشاطك — وكمان أفحص إعلانك قبل النشر.",
  ...
  en: {
    ...
    welcome: "Hello! 👋 I'm Nader, your assistant at PostLab's marketing services. Tell me about your business and I'll generate your posts and ad copy in authentic Libyan, design visuals with your brand identity — and check your ads before you publish.",
