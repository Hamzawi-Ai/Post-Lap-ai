    ...
    <div className="min-h-screen bg-background text-foreground" dir="rtl">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="leading-relaxed text-muted-foreground">
            PostLapAI هي منصة ذكاء اصطناعي تساعدك على إنشاء محتوى تسويقي جاهز للنشر — توليد النصوص الإعلانية باللهجة الليبية، تصميم منشورات بهوية نشاطك، والمساعد الذكي حمزاوي. وتشمل خدماتنا أيضاً فحص الصور والفيديو ومطابقتها مع سياسات Meta كأداة مساندة.
          </p>
        </section>
